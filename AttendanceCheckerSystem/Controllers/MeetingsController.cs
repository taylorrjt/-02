...
namespace AttendanceCheckerSystem.Controllers
{
    public class MeetingsController : Controller
    {
        ...
        {
            //Where will make a list of many things where (Critiria here)
            var selectedList = _context.AttendMeeting.Where(m => m.MeetingID == vm.MeetingID && m.StudentID == vm.StudentID);

            //Find is a search function.  It will look for what you tell it to.
            ...
            //This will return to the View "StudentAttendanceConfirmed"
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            //This will populate the meetings page with dates.
